...
<?php if(isset($_POST['delete']))
{
    ...
    $query_mem="DELETE * FROM member WHERE id = 33 ";
...
<body style="background-color: rgba(0,255,255,.8);">
    ...
    <div class="regForm"  style="text-align: center;" > 
        ...
        <div class="form-group  has-feedback">
            <label>User ID</label>
            <input type="text" class="form-control" id="ID" value="<?php echo $id; ?>"  name="did">
            <span class="glyphicon glyphicon-sunglasses form-control-feedback" ></span>   
          </div>
         <button type="submit" name="mdel" class="btn btn-danger" >Confirm Delete</button>
